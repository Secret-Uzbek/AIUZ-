...
Документ описывает идентификационную архитектуру участников системы AIUZ/UBITIQUE. Входит в уровень L3, поддерживает DAO, семантическую устойчивость и защR&D центра от анонимных атак.
